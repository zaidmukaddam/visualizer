  ...
  return (
    <>
      ...
      <header
        className={clsx(
          styles.header,
          'flex w-full justify-between mx-auto p-5 sm:p-6 md:px-6 lg:px-12 h-16 items-center font-mono font-semibold'
        )}
      >
        ...
        <nav>
          <ul className="flex">
            ...
            <li>
              <a
                href="https://github.com/zaidmukaddam/visualizer"
                rel="noreferrer"
                target="_blank"
              >
                GitHub
